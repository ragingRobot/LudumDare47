...
export default class extends Phaser.Scene {
  ...
  create() {
    ...
    // const relativeSpace = this.cameras.main.getWorldPoint(
  ...
  setupLevel() {
    ...
    this.obstaclesLayer = this.map
      .createStaticLayer("obstacles", tileset)
    ...
    this.text.setColor("black");
     ...
     //rectangle
     this.rect = new Phaser.Geom.Rectangle(250, 500, 500, 100);
     this.graphics = this.add.graphics({ fillStyle: { color: 0x000000 } });
    ...
    this.MessageBox.setFontSize(50);
    this.MessageBox.setColor("white");
   
  }

  //Add Message
  showMessage(message = "Hello Prisoner") {
  ...
  update() {
    ...
    this.text.setPosition(relativeSpace.x, relativeSpace.y);
    this.MessageBox.setPosition(relativeSpace.x + 750, relativeSpace.y + 750);
    this.rect.setPosition(relativeSpace.x + 500, relativeSpace.y + 500);
  }
}
